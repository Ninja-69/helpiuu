...
export default async function Page() {
  ...
  const dailyStats = {
    ...
    protein: meals?.reduce((sum, meal) => sum + (meal.protein_g || 0), 0) || 0,
    carbs: meals?.reduce((sum, meal) => sum + (meal.carbs_g || 0), 0) || 0,
    fat: meals?.reduce((sum, meal) => sum + (meal.fat_g || 0), 0) || 0,
  }
